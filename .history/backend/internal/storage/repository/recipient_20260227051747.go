...
func (r *RecipientRepository) Create(ctx context.Context, rec *Recipient) error {
    ...
    query := `
        INSERT INTO recipients (
            id, list_id, email, name, first_name, last_name, status, 
    ...
    err := r.db.QueryRowContext(ctx, query,
        rec.ID,           // $1
        rec.ListID,       // $2 campaigns.id FK
        rec.Email,        // $3
        rec.Name,         // $4
        rec.FirstName,    // $5
        rec.LastName,     // $6
        "pending",        // $7 status DEFAULT
        customFieldsJSON, // $8 custom_fields jsonb
        metaJSON,         // $9 metadata jsonb
