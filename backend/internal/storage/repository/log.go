...
func (r *LogRepository) InsertBatch(ctx context.Context, entries []*LogEntry) error {
        ...
        for _, entry := range entries {
                ...
                valueStrings = append(valueStrings, fmt.Sprintf(
                        ...
                        argPos+37, argPos+38, argPos+39, argPos+40, argPos+41,
                ))
...
func (r *LogRepository) List(ctx context.Context, filter *LogFilter) ([]*LogEntry, int64, error) {
        ...
        allowedLogCols := []string{"id", "time", "level", "category", "campaign_id", "account_id", "recipient_id", "message", "created_at", "duration_ms", "http_status"}
        sortBy := sanitizeSortColumn(filter.SortBy, "time", allowedLogCols)
