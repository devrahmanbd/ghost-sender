...
func NewRouter(
	...
	templates.HandleFunc("/{id}/preview", templateHandler.PreviewTemplate).Methods(http.MethodPost)
	templates.HandleFunc("/{id}/spam-check", templateHandler.CheckSpam).Methods(http.MethodPost)
	templates.HandleFunc("/{id}/variables", templateHandler.GetTemplateVariables).Methods(http.MethodGet)
	templates.HandleFunc("/{id}/validate", templateHandler.ValidateTemplate).Methods(http.MethodPost)
	templates.HandleFunc("/{id}/duplicate", templateHandler.DuplicateTemplate).Methods(http.MethodPost)
